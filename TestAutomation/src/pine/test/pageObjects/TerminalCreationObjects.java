...
public class TerminalCreationObjects {
	...
	@FindBy(how = How.XPATH, using = "//*[@id=\"ContentPlaceHolder1_PVMDDL\"]/option[1786]")
	public WebElement PVMPax;
	
	@FindBy(how = How.XPATH, using = "//*[@id=\"ContentPlaceHolder1_PVMDDL\"]/option[3379]")
	public WebElement PVMVerifone;
